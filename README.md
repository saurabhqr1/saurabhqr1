...
```python
saurabh = {
    "role"        : "AI Student & Cybersecurity Enthusiast",
    "focus"       : ["Machine Learning", "NLP", "Generative AI", "Ethical Hacking"],
    "languages"   : ["Python", "Java", "C", "C++", "HTML"],
    "certified"   : "Oracle Cloud Infrastructure 2025 — Generative AI Professional",
    "currently"   : "Exploring LLMs, RAG pipelines & Penetration Testing",
    "goal"        : "Build intelligent & secure real-world systems"
}
```
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>A collection of Jupyter notebooks covering end-to-end NLP — text preprocessing, feature extraction (BoW / TF-IDF), topic modeling with LDA & LSA, and a full text classification pipeline.</p>
      <p>
    ...
    <td width="50%">
      ...
      <p>21 hands-on cybersecurity assignments covering tools like Nmap, Zphisher, OpenStego, Cewl, Crunch, hash cracking, Google hacking, web scraping, backdoor attacks, and more — all documented as PDFs.</p>
      <p>
  ...
  <tr>
    <td width="50%">
      ...
      <p>40+ Java programs spanning DSA problems (two sum, array rotation, binary search), pattern printing, OOP concepts, number theory, and function usage — consistently updated.</p>
      <p>
    ...
    <td width="50%">
      ...
      <p>LeetCode problems solved in C++, C, and Java with tracked time & space complexity via LeetHub. Problems include two-sum, palindrome, longest substring, array rotation, and missing number.</p>
      <p>
...
- 🔐 Completed 21+ hands-on cybersecurity practicals (Kali Linux toolchain)
- 📘 Active across AI/ML, NLP, DSA & Security repositories
...
| 🔐 **Cybersecurity** | Penetration testing, bug bounty hunting, CTF challenges |
| 🚀 **MLOps** | Model deployment, Streamlit/FastAPI apps, CI/CD for ML |
...
<p align="center">
  <em>⚡ Building at the intersection of AI and security — one commit at a time 🚀</em>
</p>
